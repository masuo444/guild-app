...
const hubs = [
  ...
  // Ireland - Tullamore
  { name: 'Charleville Castle', description: '城', address: 'Charleville Castle, Tullamore, Co. Offaly, R35 RP77, Ireland', country: 'Ireland', city: 'Tullamore', lat: 53.2745, lng: -7.4930 },
  // Ireland - Galway
  ...
  // Portugal - Funchal
  { name: 'FugaCidade', description: 'バー', address: 'Rua Conde de Canavial 22, Funchal, Madeira 9000-024, Portugal', country: 'Portugal', city: 'Funchal', lat: 32.6480, lng: -16.9080 },
  // Georgia - Tbilisi
  { name: 'SOMA Noodle Cafe', description: 'ラーメン', address: '72 Merab Kostava St, Tbilisi 0171, Georgia', country: 'Georgia', city: 'Tbilisi', lat: 41.7098, lng: 44.7930 },
  // UAE - Dubai
  ...
  // Japan - 岐阜
  { name: 'ホニャラノイエ', description: '屋内宿泊施設 / リフレッシュするなら超絶オススメ！', address: '〒501-0522 岐阜県揖斐郡大野町大字相羽283-1', country: 'Japan', city: '揖斐郡大野町', lat: 35.4487, lng: 136.6240 },
  { name: 'インターナショナル旅籠 力車イン', description: 'ホテル', address: '〒506-0016 岐阜県高山市末広町54', country: 'Japan', city: '高山市', lat: 36.1413, lng: 137.2527 },
  // Japan - 大阪
  ...
  // Japan - 埼玉
  { name: 'Cafe Choco Tea（カフェ・チョコティー）', description: 'カフェ / FOMUS枡あり。ふわもこアートはぜひ', address: '〒350-0227 埼玉県坂戸市仲町1-2', country: 'Japan', city: '坂戸市', lat: 35.9574, lng: 139.4030 },
  // Japan - 静岡
  { name: '用宗みなと横丁', description: '軽食店 / 居酒屋 まっちゃん', address: '〒421-0122 静岡県静岡市駿河区用宗2丁目17-2', country: 'Japan', city: '静岡市', lat: 34.9350, lng: 138.3700 },
  // Philippines - Cebu
  ...
  { name: 'リップル', description: 'バー', address: '1 Paseo Saturnino, Banilad, Cebu City, 6000 Philippines', country: 'Philippines', city: 'Cebu City', lat: 10.3350, lng: 123.9000 },
  // Vietnam - Ho Chi Minh City
  { name: '割烹多ま Sushi OMAKASE TAMA (Japanese Cuisine)', description: '日本料理 / FOMUSくま 滞在（閉業）', address: '8A/7C1 Thái Văn Lung, Bến Nghé, Quận 1, Hồ Chí Minh, Vietnam', country: 'Vietnam', city: 'Ho Chi Minh City', lat: 10.7809, lng: 106.7015 },
  ...
  // Japan - 広島
  { name: '尾道A邸', description: null, address: '〒722-0054 広島県尾道市尾崎本町10-7', country: 'Japan', city: '尾道市', lat: 34.4089, lng: 133.2051 },
  { name: '佐木島アートギャラリー (Sagishima Art Gallery)', description: 'アートギャラリー', address: '広島県三原市佐木島', country: 'Japan', city: '三原市', lat: 34.3300, lng: 133.1000 },
  // Japan - 青森
  { name: '株式会社 竹浪酒造店', description: '日本酒醸造所', address: '〒038-3662 青森県北津軽郡板柳町板柳土井113-1', country: 'Japan', city: '板柳町', lat: 40.6940, lng: 140.4560 },
  { name: 'アウル∞珈琲', description: 'コーヒーショップ', address: '〒038-3133 青森県つがる市木造末広36-8', country: 'Japan', city: 'つがる市', lat: 40.8090, lng: 140.3690 },
  ...
  { name: 'SUSHI ORIBE KL（寿司 織部）', description: '寿司', address: 'Vipod Residences, Ground Floor Block C-1, No 6, Jalan Kia Peng, 50450 Kuala Lumpur, Malaysia', country: 'Malaysia', city: 'Kuala Lumpur', lat: 3.1515, lng: 101.7170 },
  // Japan - 奈良
  ...
  { name: 'LION KITCHEN（ライオンキッチン）', description: '日本式洋食レストラン', address: '〒602-0825 京都府京都市上京区表町23 桝形ビル1F', country: 'Japan', city: '京都市', lat: 35.0303, lng: 135.7703 },
  { name: '満寿形屋', description: '寿司', address: '京都府京都市上京区桝形通出町西入ル二神町179', country: 'Japan', city: '京都市', lat: 35.0303, lng: 135.7710 },
  { name: 'bar asso', description: 'バー', address: '〒605-0062 京都府京都市東山区林下町434', country: 'Japan', city: '京都市', lat: 35.0065, lng: 135.7815 },
  ...
  { name: '京都のチーズ屋さん プチシャレ', description: 'カフェ', address: '京都市東山区山田町494', country: 'Japan', city: '京都市', lat: 34.9990, lng: 135.7730 },
  { name: 'ノマドマ伏見 風と土が混ざり合うコワーキングスペース by ColiveKyoto', description: 'コワーキングスペース', address: '〒612-8081 京都市伏見区新町4-469 ベルエール桃山B棟1階奥', country: 'Japan', city: '京都市', lat: 34.9350, lng: 135.7620 },
  // Taiwan
  { name: 'TIKI REPUBLIK', description: 'バー', address: '新北市貢寮區東興街17-2號', country: 'Taiwan', city: '貢寮區', lat: 25.0220, lng: 121.9080 },
  { name: '湯記口味肉松老店', description: '食品製造業者', address: '桃園市中壢區大同路161號', country: 'Taiwan', city: '中壢區', lat: 24.9570, lng: 121.2260 },
  // Japan - 愛知
  { name: 'CAFE TOLAND カフェトゥーランド', description: 'カフェ', address: "〒460-0011 愛知県名古屋市中区大須4丁目11-5 Z's building 6F", country: 'Japan', city: '名古屋市', lat: 35.1560, lng: 136.9080 },
  // Japan - 佐賀
  { name: 'Guild（ギルド）', description: '立食形式の飲食店', address: '佐賀県武雄市武雄町本町7329', country: 'Japan', city: '武雄市', lat: 33.1950, lng: 130.0190 },
  // Japan - 東京
  { name: 'CryptoBar P2P', description: 'バー', address: '〒104-0061 東京都中央区銀座5-6-8 1F', country: 'Japan', city: '東京', lat: 35.6710, lng: 139.7630 },
  // Japan - 千葉
  { name: 'SOTOCHIKU & 89 unLtd. （パクチー銀行）', description: 'カフェ', address: '〒299-1902 千葉県安房郡鋸南町保田65-2', country: 'Japan', city: '鋸南町', lat: 35.1460, lng: 139.8490 },
  // Japan - 岩手
  { name: 'ルナール', description: 'デザートショップ', address: '盛岡市上太田上吉本24-3', country: 'Japan', city: '盛岡市', lat: 39.6800, lng: 141.1400 },
  // Japan - 徳島
  { name: '吉野川ギルド', description: 'シェアキッチン', address: '〒779-3403 徳島県吉野川市山川町前川201', country: 'Japan', city: '吉野川市', lat: 34.0290, lng: 134.1730 },
  { name: 'ウダツインキュベーションセンター', description: 'コミュニティセンター', address: '美馬市脇町字脇町123', country: 'Japan', city: '美馬市', lat: 34.0660, lng: 134.1480 },
  { name: 'ゲストハウスのどけや本館', description: 'ゲストハウス', address: '〒779-3610 徳島県美馬市脇町大字脇町117-1', country: 'Japan', city: '美馬市', lat: 34.0660, lng: 134.1480 },
]
