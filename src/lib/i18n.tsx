...
const translations = {
  ja: {
    ...
    menuTitle: 'メニュー',
    menuShop: 'ショップ',
    menuShopDesc: 'ポイントで交換・限定グッズ',
    menuSales: '枡を紹介する',
    menuSalesDesc: '紹介コードで売上の10%をポイント還元',
    menuAdmin: '管理画面',
    menuAdminDesc: 'メンバー・クエスト・メルマガ',
    onboardingName: '表示名',
    onboardingNameHint: 'ギルド内で表示される名前です。あとから変更できます。',
    onboardingCountry: 'お住まいの国（任意）',
    onboardingStart: 'はじめる',
    onboardingSkip: 'あとで設定する',
    map: 'マップ',
    offers: 'クエスト',
    shop: 'ショップ',
    sales: '紹介',
    ...
    // Referral (枡の紹介)
    salesTitle: '枡を紹介する',
    salesIntro: 'あなたの紹介で枡が売れると、売上の10%がポイントで還元されます。貯まったポイントは交換所で使えます。',
    salesYourCode: 'あなたの紹介コード',
    salesCopyCode: 'コードをコピー',
    salesShareTitle: '紹介リンク',
    salesShareNote: 'このリンクから入った方は、購入時にコードが自動で入ります（30日間有効）。SNSやメールでそのまま共有してください。',
    salesCopyLink: 'リンクをコピー',
    salesCopied: 'コピーしました',
    salesCodeNote: 'FOMUS SHOPの購入画面でこのコードを入力してもらっても成立します。',
    salesTotalPoints: '累計還元ポイント',
    salesTotalAmount: '紹介経由の売上合計',
    salesHistory: '還元履歴',
    salesNoHistory: 'まだ紹介実績はありません',
    salesPurchase: 'の購入',
    salesViewShop: 'FOMUS SHOPで枡を見る',
    salesLoadError: '読み込みに失敗しました',
    salesDisclosure: '紹介で報酬を受け取る場合は、広告・PRであることが分かるように書いてください（例: #PR、「FOMUS GUILDの紹介です」）。',
    profile: 'プロフィール',
    admin: '管理',
    ...
    signOut: 'サインアウト',
    inviteFriends: '友達を招待',
    inviteFriendsDesc: '招待コードを発行して友達をFOMUS GUILDに招待できます。招待された方はギルドメンバーとして参加できます。招待が成立すると、あなたに100ポイント、招待された方には150ポイント（Welcome Bonus 100pt+Invitedボーナス50pt）が付与されます！',
    ...
    upgradeSeeMembersDesc: '無料プランは記事を楽しむプランです。有料版でメンバーとMASU Hubのマップを使えます。',
    upgrade: 'アップグレード',
    fullscreen: '全画面',
    ...
    comingSoon: '近日公開',
    articlePasswordNote: '記事を読むにはパスワードの入力が必要です。',
    articlePasswordValue: 'fomus2000',
    articlePasswordWarning: 'パスワードの外部公開は禁止です。',
    articleReadButton: '記事を読む',
    ...
    guideQuestDesc: 'クエストに参加してポイントを獲得しましょう。貯まったMASUポイントはFOMUSの商品・サービスと交換できます。交換コンテンツは今後も続々追加予定です。',
    guideQuestEarn: 'クエストをクリアしてポイント獲得',
    guideQuestServices: 'FOMUS関連サービスにアクセス',
    guideQuestArticles: '限定記事（近日公開）',
    guideQuestExchange: '溜まったMASUポイントでFOMUSの商品・サービスと交換可能。交換コンテンツは今後さらに拡充予定',
    ...
    // Guide Page - How-to Sections
    guideHowToTitle: '使い方詳細ガイド',
    guideHowToSubtitle: '各機能の具体的な操作手順をステップバイステップで解説します。',
    ...
    guideProfileSetupStep1: '画面下部の「プロフィール」タブ → 「プロフィール編集」をタップします',
    guideProfileSetupStep2: '表示名とプロフィール画像を設定します（枡フォトがおすすめ！）',
    guideProfileSetupStep3: '位置情報（国・都道府県・市区町村）を入力します',
    guideProfileSetupStep4: '「マップに位置を表示」をONにすると、ギルドマップにあなたのピンが表示されます',
    guideProfileSetupStep5: 'カードテーマを選択して、メンバーシップカードのデザインを変更できます',

    guideCardDetailTitle: 'メンバーシップカードの見方',
    guideCardDetailDesc: 'デジタル会員証の各要素を理解しましょう。',
    guideCardDetailFront: '【表面】プロフィール画像、表示名、メンバーシップID、ランクが表示されます',
    guideCardDetailBack: '【裏面】Guild EXP（ステータスポイント）、MASU Points（交換用ポイント）、加入日、QRコードが表示されます。カードをタップすると裏面を見れます。',
    guideCardDetailRankPoints: 'ランクはGuild EXP（ステータスポイント）に基づいて決まります。クエスト達成やログインボーナスでポイントを貯めてランクアップしましょう！',

    guideMapUsageTitle: 'ギルドマップの使い方',
    guideMapUsageDesc: '世界中のメンバーやMASU Hubを探索しましょう。',
    guideMapUsageStep1: '画面下部の「マップ」タブをタップして、ギルドマップを開きます',
    guideMapUsageStep2: '上部の検索バーで名前・都市・国を検索し、「メンバー」「Hub」タブで表示を切り替えます',
    guideMapUsageStep3: 'MASU Hubのピンをタップすると、店舗名・説明・Google Mapsリンクが表示されます',
    guideMapUsageStep4: 'メンバーのピンをタップすると、プロフィール画像と表示名が表示されます（有料メンバーのみ）',

    guideQuestHowTitle: 'クエストの参加方法',
    guideQuestHowDesc: 'クエストに参加してポイントを獲得しましょう。',
    guideQuestHowStep1: '画面下部の「クエスト」タブをタップして、利用可能なクエスト一覧を確認します',
    guideQuestHowStep2: '参加したいクエストをタップして詳細を確認します',
    guideQuestHowStep3: 'フォトクエスト：写真をアップロード / チェックイン：指定の場所でチェックイン / アクション：指定のアクションを実行して「投稿する」をタップします',
    guideQuestHowStep4: '投稿は管理者によって審査されます。承認されるとポイントが付与されます',

    guideExchangeHowTitle: 'ポイント交換',
    guideExchangeHowDesc: '溜まったMASUポイントを商品やサービスと交換しましょう。',
    guideExchangeHowStep1: '「クエスト」タブを開き、「ポイント交換所」セクションへスクロールします',
    guideExchangeHowStep2: '交換したいアイテムを選択し、必要ポイントと在庫を確認します',
    guideExchangeHowStep3: '「交換する」をタップして交換を申請します',
    guideExchangeHowStep4: '交換履歴でステータス（申請中 → 承認済み）を確認できます。クーポンコードが発行される場合もあります',

    guideInviteHowTitle: '友達を招待する方法',
    guideInviteHowDesc: '招待コードを発行して、友達をFOMUS GUILDに招待しましょう。',
    guideInviteHowStep1: '「プロフィール」タブ → 「友達を招待」セクションを開きます',
    guideInviteHowStep2: '「招待コードを発行」ボタンをタップして、新しい招待コードを生成します',
    guideInviteHowStep3: '表示された招待URLの「リンク」ボタンをタップしてURLをコピーします',
    guideInviteHowStep4: 'コピーしたURLをSNS、メール、メッセージアプリで友達に共有します',

    guidePwaInstallTitle: 'アプリのインストール（PWA）',
    guidePwaInstallDesc: 'FOMUS GUILDはPWA（Progressive Web App）として、ホーム画面に追加してアプリのように使えます。',
    guidePwaInstallAndroidTitle: 'Android',
    guidePwaInstallAndroid1: 'ブラウザに表示される「インストール」バナーをタップします',
    guidePwaInstallAndroid2: 'またはブラウザメニュー（⋮）→「アプリをインストール」を選択します',
    guidePwaInstallIosTitle: 'iOS（iPhone / iPad）',
    guidePwaInstallIos1: 'Safariで画面下部の共有ボタン（↑）をタップします',
    guidePwaInstallIos2: '「ホーム画面に追加」を選択します',
    guidePwaInstallIos3: '右上の「追加」をタップして完了です',

    // About Page
    aboutTitle: 'FOMUS GUILDについて',
    aboutHeroCatchcopy: '枡から広がる、世界とつながるギルド。',
    aboutHeroSubtitle: '日本の伝統工芸「枡」を起点に、世界中の仲間をつなぐコミュニティ。',
    aboutWhatIsTitle: 'FOMUS GUILDとは',
    aboutWhatIsDesc: 'FOMUS GUILDは、日本の伝統工芸「枡（MASU）」を起点に生まれたグローバル文化コミュニティです。メンバーは「ユーザー」ではなく、文化づくりの"仲間"として迎えられます。枡という小さな木の器を通じて、日本の美意識と世界をつなぎ、新しい文化の形を一緒に創り上げていく場所です。',
    aboutFeaturesTitle: '5つの特徴',
    aboutFeature1Title: 'デジタル会員証',
    aboutFeature1Desc: '7段階のランクシステム（E〜SS）を搭載したデジタルメンバーシップカード。活動に応じてランクアップし、あなたのギルドでの貢献を証明します。',
    aboutFeature2Title: 'ギルドマップ',
    aboutFeature2Desc: '世界中のメンバーの分布とMASU Hub（提携店舗・スポット）をマップで確認。リアルなつながりを見つけましょう。',
    aboutFeature3Title: 'クエスト & ポイント',
    ...
    aboutMembershipFreeFeatures: '無料記事の閲覧 / 月別・カテゴリ別の記事一覧',
    aboutMembershipPaidTitle: '有料プラン',
    aboutMembershipPaidPrice: '¥980/月 または $10/月',
    aboutMembershipPaidFeatures: '全機能にアクセス / ギルドマップでメンバー閲覧 / クエスト参加 / ポイント交換 / メンバー限定特典',
    aboutBrandsTitle: 'FOMUSブランド',
    aboutBrandsSubtitle: 'FOMUSが展開する多彩なブランド・プロジェクトをご紹介します。',
    aboutHowToJoinTitle: '参加方法',
    aboutHowToJoinStep1: 'メールアドレスで無料参加を始める',
    aboutHowToJoinStep2: 'メールアドレスで登録・認証',
    aboutHowToJoinStep3: 'ギルド開始！冒険を始めよう',
    aboutCtaTitle: 'ギルドに参加しよう',
    aboutCtaDesc: '招待コード不要。まずは無料記事から。有料版ならマップで仲間と拠点を探せます。',
    aboutCtaButton: 'ギルドに入る',
    aboutBrandMasu: 'MASU',
    aboutBrandMasuPhoto: 'MASU Photo',
    aboutBrandParure: 'FOMUS PARURE',
    aboutBrandKuku: 'KUKU',
    aboutBrandSilva: 'SILVA',
  ...
  en: {
    ...
    menuTitle: 'Menu',
    menuShop: 'Shop',
    menuShopDesc: 'Redeem points & exclusive goods',
    menuSales: 'Refer Masu',
    menuSalesDesc: 'Earn 10% of sales back as points with your code',
    menuAdmin: 'Admin',
    menuAdminDesc: 'Members, quests, newsletter',
    onboardingName: 'Display name',
    onboardingNameHint: 'Shown inside the guild. You can change it later.',
    onboardingCountry: 'Country (optional)',
    ...
    // Referral
    salesTitle: 'Refer MASU',
    salesIntro: 'When someone buys a MASU through your referral, you get 10% of the sale back in points. Spend your points in the exchange.',
    salesYourCode: 'Your referral code',
    salesCopyCode: 'Copy code',
    salesShareTitle: 'Referral link',
    salesShareNote: 'Anyone who arrives through this link gets your code filled in automatically at checkout (valid 30 days). Share it as it is.',
    salesCopyLink: 'Copy link',
    salesCopied: 'Copied',
    salesCodeNote: 'It also works if they type the code into the FOMUS SHOP checkout themselves.',
    salesTotalPoints: 'Points earned',
    salesTotalAmount: 'Sales through your referrals',
    salesHistory: 'History',
    salesNoHistory: 'No referrals yet',
    salesPurchase: ' purchase',
    salesViewShop: 'See MASU at FOMUS SHOP',
    salesLoadError: 'Failed to load',
    salesDisclosure: 'If you earn a reward from a referral, make it clear that the post is promotional (for example #ad, or "referral link").',
    profile: 'Profile',
    admin: 'Admin',
    ...
    inviteFriendsDesc: 'Generate invite codes to invite friends to FOMUS GUILD. They will join as guild members. When an invite is completed, you receive 100 points and the invited person receives 150 points (100pt Welcome Bonus + 50pt Invited Bonus)!',
    ...
    upgradeSeeMembersDesc: 'The free plan includes articles. Upgrade to explore members and MASU Hubs on the map.',
    upgrade: 'Upgrade',
    ...
    articlePasswordNote: 'A password is required to read the articles.',
    articlePasswordValue: 'fomus2000',
    articlePasswordWarning: 'Sharing this password externally is prohibited.',
    articleReadButton: 'Read Articles',
    ...
    sakuraTheme: 'Sakura',
    royalTheme: 'Royal (European)',
    arabianTheme: 'Arabian',
    ...
    guideQuestDesc: 'Participate in quests to earn points. Exchange your MASU Points for FOMUS products and services. More exchange items are being added regularly.',
    ...
    guideQuestExchange: 'Exchange accumulated MASU Points for FOMUS products & services. More exchange items coming soon',
    ...
    // Guide Page - How-to Sections
    guideHowToTitle: 'Detailed How-To Guide',
    guideHowToSubtitle: 'Step-by-step instructions for each feature.',
    ...
    guideProfileSetupStep1: 'Tap the "Profile" tab at the bottom → tap "Edit Profile"',
    guideProfileSetupStep2: 'Set your display name and profile image (Masu Photo recommended!)',
    guideProfileSetupStep3: 'Enter your location (country, state/prefecture, city)',
    guideProfileSetupStep4: 'Turn ON "Show location on map" to display your pin on the Guild Map',
    guideProfileSetupStep5: 'Choose a card theme to change your membership card design',

    guideCardDetailTitle: 'Understanding Your Membership Card',
    guideCardDetailDesc: 'Learn about each element of your digital membership card.',
    guideCardDetailFront: '[Front] Displays your profile image, display name, membership ID, and rank',
    guideCardDetailBack: '[Back] Shows Guild EXP (status points), MASU Points (exchange points), join date, and QR code. Tap the card to flip it.',
    guideCardDetailRankPoints: 'Your rank is determined by Guild EXP (status points). Earn points by completing quests and login bonuses to rank up!',

    guideMapUsageTitle: 'Using the Guild Map',
    guideMapUsageDesc: 'Explore members and MASU Hubs around the world.',
    guideMapUsageStep1: 'Tap the "Map" tab at the bottom to open the Guild Map',
    guideMapUsageStep2: 'Use the search bar to search by name, city, or country. Switch between "Members" and "Hubs" tabs',
    guideMapUsageStep3: 'Tap a MASU Hub pin to view shop name, description, and Google Maps link',
    guideMapUsageStep4: 'Tap a member pin to view their profile image and display name (paid members only)',

    guideQuestHowTitle: 'How to Join Quests',
    guideQuestHowDesc: 'Participate in quests to earn points.',
    guideQuestHowStep1: 'Tap the "Quests" tab at the bottom to see available quests',
    guideQuestHowStep2: 'Tap a quest to view its details',
    guideQuestHowStep3: 'Photo Quest: upload a photo / Check-in: check in at the designated location / Action: complete the action and tap "Submit"',
    guideQuestHowStep4: 'Submissions are reviewed by admins. Points are awarded upon approval',

    guideExchangeHowTitle: 'Point Exchange',
    guideExchangeHowDesc: 'Exchange your accumulated MASU Points for products and services.',
    guideExchangeHowStep1: 'Open the "Quests" tab and scroll to the "Point Exchange" section',
    guideExchangeHowStep2: 'Select an item and check the required points and stock',
    guideExchangeHowStep3: 'Tap "Exchange" to submit your exchange request',
    guideExchangeHowStep4: 'Check your exchange history for status updates (Pending → Approved). Coupon codes may be issued',

    guideInviteHowTitle: 'How to Invite Friends',
    guideInviteHowDesc: 'Generate invite codes to invite friends to FOMUS GUILD.',
    guideInviteHowStep1: 'Go to the "Profile" tab → open the "Invite Friends" section',
    guideInviteHowStep2: 'Tap "Generate Invite Code" to create a new invite code',
    guideInviteHowStep3: 'Tap the "Link" button on the generated invite URL to copy it',
    guideInviteHowStep4: 'Share the copied URL with friends via SNS, email, or messaging apps',

    guidePwaInstallTitle: 'Installing the App (PWA)',
    guidePwaInstallDesc: 'FOMUS GUILD is a PWA (Progressive Web App) that can be added to your home screen and used like a native app.',
    guidePwaInstallAndroidTitle: 'Android',
    guidePwaInstallAndroid1: 'Tap the "Install" banner shown in your browser',
    guidePwaInstallAndroid2: 'Or tap the browser menu (⋮) → "Install app"',
    guidePwaInstallIosTitle: 'iOS (iPhone / iPad)',
    guidePwaInstallIos1: 'In Safari, tap the Share button (↑) at the bottom of the screen',
    guidePwaInstallIos2: 'Select "Add to Home Screen"',
    guidePwaInstallIos3: 'Tap "Add" in the top right to finish',

    // About Page
    aboutTitle: 'About FOMUS GUILD',
    aboutHeroCatchcopy: 'A guild connecting the world, starting from MASU.',
    aboutHeroSubtitle: 'An invitation-only community connecting people worldwide through the Japanese traditional craft of MASU.',
    aboutWhatIsTitle: 'What is FOMUS GUILD?',
    aboutWhatIsDesc: 'FOMUS GUILD is a global cultural community born from the Japanese traditional craft of MASU. Members are welcomed not as users, but as companions in cultural creation. Through a small wooden cup called MASU, we connect Japanese aesthetics with the world and co-create new forms of culture together.',
    aboutFeaturesTitle: '5 Key Features',
    aboutFeature1Title: 'Digital Membership Card',
    aboutFeature1Desc: 'A digital membership card with a 7-tier rank system (E to SS). Rank up through activities and prove your contributions to the guild.',
    aboutFeature2Title: 'Guild Map',
    aboutFeature2Desc: 'See member locations and MASU Hubs (partner shops & spots) on a world map. Discover real-world connections.',
    aboutFeature3Title: 'Quests & Points',
    ...
    aboutMembershipFreePrice: '¥0',
    aboutMembershipFreeFeatures: 'Read free articles / Browse posts by month and category',
    aboutMembershipPaidTitle: 'Paid Plan',
    aboutMembershipPaidPrice: '¥980/mo or $10/mo',
    aboutMembershipPaidFeatures: 'Full feature access / View members on Guild Map / Join quests / Point exchange / Member-only benefits',
    aboutBrandsTitle: 'FOMUS Brands',
    aboutBrandsSubtitle: 'Discover the diverse brands and projects by FOMUS.',
    aboutHowToJoinTitle: 'How to Join',
    aboutHowToJoinStep1: 'Receive an invite code from an existing member',
    aboutHowToJoinStep2: 'Register and verify with your email',
    aboutHowToJoinStep3: 'Start your guild journey!',
    aboutCtaTitle: 'Join the Guild',
    aboutCtaDesc: 'If you have an invite code, you can join FOMUS GUILD right now.',
    aboutCtaButton: 'Enter the Guild',
    aboutBrandMasu: 'MASU',
    aboutBrandMasuPhoto: 'MASU Photo',
    aboutBrandParure: 'FOMUS PARURE',
    aboutBrandKuku: 'KUKU',
