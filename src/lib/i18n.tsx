...
const translations = {
  ja: {
    ...
    guideGettingStartedStep4: '有料プランの場合はStripe決済画面へ進み、サブスクリプションを開始します。無料招待の場合はそのままギルドに参加できます。',
  ...
  en: {
    ...
    guideGettingStartedStep4: 'For paid plans, proceed to the Stripe payment page to start your subscription. For free invitations, you can join the guild immediately.',
