...
const translations = {
  ja: {
    ...
    aboutHeroSubtitle: '日本の伝統工芸「枡」を起点に、世界中の仲間をつなぐ招待制コミュニティ。',
    ...
    aboutMembershipFreeFeatures: 'デジタル会員証 / MASU Hubの閲覧 / ログインボーナス',
  ...
  en: {
    ...
    aboutMembershipFreePrice: '¥0',
    aboutMembershipFreeFeatures: 'Digital membership card / View MASU Hubs / Login bonus',
