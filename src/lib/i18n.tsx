...
const translations = {
  ja: {
    ...
    signOut: 'サインアウト',
    inviteFriends: '友達を招待',
    inviteFriendsDesc: '招待コードを発行して友達をFOMUS GUILDに招待できます。招待された方はギルドメンバーとして参加できます。招待が成立すると、あなたと招待された方の両方に100ポイントが付与されます！',
  ...
  en: {
    ...
    inviteFriendsDesc: 'Generate invite codes to invite friends to FOMUS GUILD. They will join as guild members. When an invite is completed, both you and the invited person will receive 100 points!',
