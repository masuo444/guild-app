...
-- Ireland - Tullamore
('Charleville Castle', '城', 'Charleville Castle, Tullamore, Co. Offaly, R35 RP77, Ireland', 'Ireland', 'Tullamore', 53.2745, -7.4930, true),
-- Ireland - Galway
...
-- Portugal - Funchal
('FugaCidade', 'バー', 'Rua Conde de Canavial 22, Funchal, Madeira 9000-024, Portugal', 'Portugal', 'Funchal', 32.6480, -16.9080, true),

-- Georgia - Tbilisi
('SOMA Noodle Cafe', 'ラーメン', '72 Merab Kostava St, Tbilisi 0171, Georgia', 'Georgia', 'Tbilisi', 41.7098, 44.7930, true),

-- UAE - Dubai
('KOBEYa', NULL, 'Marina Gate 1 Marsa, Dubai, United Arab Emirates', 'UAE', 'Dubai', 25.0800, 55.1400, true),

-- Japan - 岐阜
('ホニャラノイエ', '屋内宿泊施設 / リフレッシュするなら超絶オススメ！', '〒501-0522 岐阜県揖斐郡大野町大字相羽283-1', 'Japan', '揖斐郡大野町', 35.4487, 136.6240, true),
('インターナショナル旅籠 力車イン', 'ホテル', '〒506-0016 岐阜県高山市末広町54', 'Japan', '高山市', 36.1413, 137.2527, true),
...
-- Japan - 埼玉
('Cafe Choco Tea（カフェ・チョコティー）', 'カフェ / FOMUS枡あり。ふわもこアートはぜひ', '〒350-0227 埼玉県坂戸市仲町1-2', 'Japan', '坂戸市', 35.9574, 139.4030, true),

-- Japan - 静岡
('用宗みなと横丁', '軽食店 / 居酒屋 まっちゃん', '〒421-0122 静岡県静岡市駿河区用宗2丁目17-2', 'Japan', '静岡市', 34.9350, 138.3700, true),
...
('リップル', 'バー', '1 Paseo Saturnino, Banilad, Cebu City, 6000 Philippines', 'Philippines', 'Cebu City', 10.3350, 123.9000, true),

-- Vietnam - Ho Chi Minh City
('割烹多ま Sushi OMAKASE TAMA (Japanese Cuisine)', '日本料理 / FOMUSくま 滞在（閉業）', '8A/7C1 Thái Văn Lung, Bến Nghé, Quận 1, Hồ Chí Minh, Vietnam', 'Vietnam', 'Ho Chi Minh City', 10.7809, 106.7015, true),
...
-- Japan - 広島
('尾道A邸', NULL, '〒722-0054 広島県尾道市尾崎本町10-7', 'Japan', '尾道市', 34.4089, 133.2051, true),
('佐木島アートギャラリー (Sagishima Art Gallery)', 'アートギャラリー', '広島県三原市佐木島', 'Japan', '三原市', 34.3300, 133.1000, true),

-- Japan - 青森
('株式会社 竹浪酒造店', '日本酒醸造所', '〒038-3662 青森県北津軽郡板柳町板柳土井113-1', 'Japan', '板柳町', 40.6940, 140.4560, true),
('アウル∞珈琲', 'コーヒーショップ', '〒038-3133 青森県つがる市木造末広36-8', 'Japan', 'つがる市', 40.8090, 140.3690, true),
...
('SUSHI ORIBE KL（寿司 織部）', '寿司', 'Vipod Residences, Ground Floor Block C-1, No 6, Jalan Kia Peng, 50450 Kuala Lumpur, Malaysia', 'Malaysia', 'Kuala Lumpur', 3.1515, 101.7170, true),
...
('LION KITCHEN（ライオンキッチン）', '日本式洋食レストラン', '〒602-0825 京都府京都市上京区表町23 桝形ビル1F', 'Japan', '京都市', 35.0303, 135.7703, true),
('満寿形屋', '寿司', '京都府京都市上京区桝形通出町西入ル二神町179', 'Japan', '京都市', 35.0303, 135.7710, true),
('bar asso', 'バー', '〒605-0062 京都府京都市東山区林下町434', 'Japan', '京都市', 35.0065, 135.7815, true),
...
('京都のチーズ屋さん プチシャレ', 'カフェ', '京都市東山区山田町494', 'Japan', '京都市', 34.9990, 135.7730, true),
('ノマドマ伏見 風と土が混ざり合うコワーキングスペース by ColiveKyoto', 'コワーキングスペース', '〒612-8081 京都市伏見区新町4-469 ベルエール桃山B棟1階奥', 'Japan', '京都市', 34.9350, 135.7620, true),

-- Taiwan
('TIKI REPUBLIK', 'バー', '新北市貢寮區東興街17-2號', 'Taiwan', '貢寮區', 25.0220, 121.9080, true),
('湯記口味肉松老店', '食品製造業者', '桃園市中壢區大同路161號', 'Taiwan', '中壢區', 24.9570, 121.2260, true),

-- Japan - 愛知
('CAFE TOLAND カフェトゥーランド', 'カフェ', '〒460-0011 愛知県名古屋市中区大須4丁目11-5 Z''s building 6F', 'Japan', '名古屋市', 35.1560, 136.9080, true),

-- Japan - 佐賀
('Guild（ギルド）', '立食形式の飲食店', '佐賀県武雄市武雄町本町7329', 'Japan', '武雄市', 33.1950, 130.0190, true),

-- Japan - 東京
('CryptoBar P2P', 'バー', '〒104-0061 東京都中央区銀座5-6-8 1F', 'Japan', '東京', 35.6710, 139.7630, true),

-- Japan - 千葉
('SOTOCHIKU & 89 unLtd. （パクチー銀行）', 'カフェ', '〒299-1902 千葉県安房郡鋸南町保田65-2', 'Japan', '鋸南町', 35.1460, 139.8490, true),

-- Japan - 岩手
('ルナール', 'デザートショップ', '盛岡市上太田上吉本24-3', 'Japan', '盛岡市', 39.6800, 141.1400, true),

-- Japan - 徳島
('吉野川ギルド', 'シェアキッチン', '〒779-3403 徳島県吉野川市山川町前川201', 'Japan', '吉野川市', 34.0290, 134.1730, true),
('ウダツインキュベーションセンター', 'コミュニティセンター', '美馬市脇町字脇町123', 'Japan', '美馬市', 34.0660, 134.1480, true),
('ゲストハウスのどけや本館', 'ゲストハウス', '〒779-3610 徳島県美馬市脇町大字脇町117-1', 'Japan', '美馬市', 34.0660, 134.1480, true);
